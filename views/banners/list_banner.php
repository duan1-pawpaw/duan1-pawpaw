                                    ...
                                    <table class="table table-bordered">
                                        <thead class="thead-dark">
                                            <tr>
                                                ...
                                                <th>Ẩn/Hiện</th>
                                                <th>
                                                    <a class="d-inline p-2 text-bg-dark" href="?act=add_banner"><button type="button" class="btn btn-success  ">Thêm Mới</button></a>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php foreach ($products as $index => $ds) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <th> <?= $ds["tieu_de"] ?> </th>
                                                    <th><img style="width: 100px; height: 100px" src="./imgBanner/<?= $ds['hinh_anh'] ?>" alt=""></th>
                                                    <th>
