                    ...
                    <div class="col-xl-3 col-md-6 col-12">
                        <div class="footer-infor">
                            <div class="footer-logo">
                                <a href="index.html">
                                    <img src="./assets/assets_font/images/logo/logo.svg" alt="">
                                </a>
                            </div>
                            <ul>
                                <li>
                                ...
                                <div class="tf-cur">
                                    <div class="tf-currencies">
                                        <select class="image-select center style-default type-currencies">
                                            <option data-thumbnail="./assets/assets_font/images/country/fr.svg">EUR <span>€ | France</span></option>
                                            <option data-thumbnail="./assets/assets_font/images/country/de.svg">EUR <span>€ | Germany</span></option>
                                            <option selected data-thumbnail="./assets/assets_font/images/country/us.svg">USD <span>$ | United States</span></option>
                                            <option data-thumbnail="./assets/assets_font/images/country/vn.svg">VND <span>₫ | Vietnam</span></option>
                                        </select>
                                    </div>
                    ...
                    <div class="col-12">
                        <div class="footer-bottom-wrap d-flex gap-20 flex-wrap justify-content-between align-items-center">
                            ...
                            <div class="tf-payment">
                                <img src="./assets/assets_font/images/payments/visa.png" alt="">
                                <img src="./assets/assets_font/images/payments/img-1.png" alt="">
                                <img src="./assets/assets_font/images/payments/img-2.png" alt="">
                                <img src="./assets/assets_font/images/payments/img-3.png" alt="">
                                <img src="./assets/assets_font/images/payments/img-4.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
