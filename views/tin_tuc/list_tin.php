                                    ...
                                    <table class="table table-bordered">
                                        <thead class="thead-dark">
                                            <tr>
                                                ...
                                                <th>Ẩn/Hiện</th>
                                                <th>
                                                    <a class="d-inline p-2 text-bg-dark" href="?act=add_tin"><button type="button" class="btn btn-success  ">Thêm Mới</button></a>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php foreach ($products as $ds2) { ?>

                                                <!-- <img src="./img/<?= $ds2['thumbnail'] ?>" alt=""> -->
                                            <?php } ?>
                                            ...
                                            <?php foreach ($products as $index => $ds) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <th> <?= $ds["tieu_de"] ?> </th>
                                                    <th> <?= $ds["mo_ta"] ?> </th>
                                                    <th><img style="width: 100px; height: 100px" src="./imgTin/<?= $ds['url_hinh'] ?>" alt=""></th>
                                                    <th>
