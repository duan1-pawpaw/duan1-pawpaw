            ...
            <div class="col-md-9 register-right">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        ?>
                        <form action="<?= BASE_URL . '?act=comfirm_registers' ?>" method="POST">
                            <!-- <input type="hidden" name="action" value="comfirm_register"> -->
                            <div class="row register-form">
                                <p>Mã Xác Thực Đã Được Gửi Đến Email Mà Bạn Đã Đăng Ký</p>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Email.." value="<?= $_POST['email']  ?? '' ?>" readonly>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="ma_xac_thuc" class="form-control" placeholder="Nhập Mã Xác Thực..." value="">
                                    </div>
                                    <?php if (isset($errors['ma_xac_thuc'])): ?>
                                        <span class="text-danger"><?= $errors['ma_xac_thuc'] ?></span>
                                    <?php endif; ?>
                                </div>
