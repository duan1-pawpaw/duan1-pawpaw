                        ...
                        <tbody>
                            ...
                            <tr class="tf-cart-item file-delete">
                                <td class="tf-cart-item_product">
                                    ...
                                    <div class="cart-info">
                                        <a href="product-detail.html" class="cart-title link"><?= $sanPham['ten_san_pham'] ?></a>
                                        <div class="cart-meta-variant"><?= $sanPham['do_tuoi'] ?></div>
                                        <div class="cart-meta-variant"><?= $sanPham['gioi_tinh'] == 1 ? 'Đực' : 'Cái'; ?></div>
