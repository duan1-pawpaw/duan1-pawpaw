...
<head>
  ...
  <link href="./assets/assets_cuong/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">

  <!-- Customized Bootstrap Stylesheet -->
  <link href="./assets/assets_cuong/css/style.css" rel="stylesheet">
</head>
...
<body>
      ...
      <div class="row">
        <div class="col-lg-8">
          <div class="row">
            <div class="col-12">
              <div>
                <h4 class="m-0 text-uppercase font-weight-bold"><?= $baiVietById['tieu_de'] ?></h4>
              </div>
            </div>
            <div class="col-lg">
              <img src="<?= $baiVietById['url_hinh'] ?>" alt="">
              <?= $baiVietById['mo_ta'] ?>
            </div>
  ...
  <script src="./assets/assets_cuong/lib/easing/easing.min.js"></script>
  <script src="./assets/assets_cuong/lib/owlcarousel/owl.carousel.min.js"></script>

  <!-- Template Javascript -->
  <script src="./assets/assets_cuong/js/main.js"></script>
