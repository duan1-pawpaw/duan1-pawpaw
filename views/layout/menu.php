            ...
            <div class="row wrapper-header align-items-center">
                <div class="col-xl-3 col-md-4 col-6">
                    <a href="<?= BASE_URL ?>" class="logo-header">
                        <img src="./assets/images/logo5.jpg" alt="logo" style="width: 250px;">
                    </a>
                </div>
                <div class="col-xl-6 tf-md-hidden">
                    <nav class="box-navigation text-center">
                        <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                            ...
                            <!-- Product -->
                            <li class="menu-item">
                                <a href="#" class="item-link"><i class="fa-solid fa-cat"></i>Thú Cưng<i class="icon icon-arrow-down"></i></a>
                            ...
                            <!-- Thức Ăn Thú Cưng -->
                            <li class="menu-item">
                                <a href="#" class="item-link"><i class="fa-solid fa-utensils"></i>Thức Ăn Thú Cưng<i class="icon icon-arrow-down"></i></a>
                                <div class="sub-menu mega-menu">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-2">
